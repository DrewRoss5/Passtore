...
from PySide6.QtWidgets import QWidget, QGridLayout, QLabel, QPushButton, QErrorMessage, QLineEdit, QApplication
...
class LoginWindow(QWidget):
    def __init__(self, file_path: str):
            super().__init__()
            self.setWindowTitle(f'Unlock {os.path.basename(file_path)}')
    ...
    def init_dialog(self):
        ...
        self.main_layout.addWidget(self.error_label, 3, 0, 1, 2)
    ...
    def decrypt_passwords(self):
        ...
        try:
            ...
            if self.attempts < 3:
                ...
                QErrorMessage(self).showMessage('An incorrect password was provided three times.\nThe program will now exit.')
                self.close()
