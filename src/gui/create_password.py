...
class PasswordCreationDialog(QWidget):
    ...
    def init_dialog(self):
        ...
        self.pass_entry.textChanged.connect(self.update_strength_meter)
        ...
        self.size_slider.valueChanged.connect(self.update_password)
        ...
        self.layout.addWidget(self.accept_button, 8, 1, 2, 1)
